...
O visualizador de imagens possui interações para desktop e dispositivos móveis:
...
O projeto ainda concentra parte relevante da experiência em um componente de página extenso. Isso funciona para a versão atual, mas a evolução recomendada é separar responsabilidades em módulos menores:
...
Essa refatoração tornará testes, manutenção e evolução mais simples.
...
Projeto desenvolvido como solução web para fotografia de natureza e birdwatching.
